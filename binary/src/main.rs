...
use process_mining::{
    ...
    export_ocel_sqlite_to_path, import_ocel_json_from_path, import_ocel_xml_file, import_xes_file,
    OCEL,
};
...
fn main() {
    ...
    let ocel = import_ocel_json_from_path("/home/aarkue/dow/bpic2017-o2o-workflow-qualifier.json")
        .unwrap();
    export_ocel_sqlite_to_path(
        &ocel,
        "/home/aarkue/dow/bpic2017-o2o-workflow-qualifier-index.sqlite",
    )
    .unwrap();

    // let ocel = import_ocel_json_from_path("/home/aarkue/dow/ocel/order-management.json").unwrap();
    // export_ocel_sqlite_to_path(&ocel, "/home/aarkue/dow/order-management-index.sqlite").unwrap();
}
